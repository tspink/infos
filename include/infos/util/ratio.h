// *** NOTE ***
// THIS IMPLEMENTATION IS TAKEN DIRECTLY FROM THE MIT LICENSED libc++ LLVM SOURCE-CODE
// *** NOTE ***
...
//#include <infos/util/type-traits.h>

namespace std {
	
	template<bool b_>
	struct bool_constant {
		static constexpr bool value = b_;
	};
	
	struct true_type : bool_constant<true> { };
	struct false_type : bool_constant<false> { };

#define _LIBCPP_BOOL_CONSTANT(b_) bool_constant<b_>
	
using intmax_t = signed long int;
#define CHAR_BIT 8
...
namespace infos {
	namespace util {
		...
		using RatioDivide = std::ratio_divide<A, B>;
	}
}
